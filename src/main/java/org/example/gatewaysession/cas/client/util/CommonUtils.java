...
import org.example.gatewaysession.cas.client.validation.ProxyList;
import org.example.gatewaysession.cas.client.validation.ProxyListEditor;
...
public final class CommonUtils {
    ...
    public static String constructServiceUrl(final HttpServletRequest request, final HttpServletResponse response,
        ...
        final String serverName = findMatchingServerName(request, serverNames); // http:..my.test.com:9091
